...
SOURCES +=     xpcfHelloWorld_main.cpp \
    WorldComponent.cpp

HEADERS +=     xpcfHelloWorldAPI.h     xpcfHelloWorld_traits.h \
    WorldComponent.h \
...
xpcf_xml_files.files=$$files($${PWD}/xpcfHelloWorld.xml)

INSTALLS += header_files target xpcf_xml_files
DISTFILES +=     Makefile \
    bcom-xpcfHelloWorld.pc.in \
    xpcfHelloWorld.xml
