...
SOURCES +=     xpcfHelloPeople_main.cpp \
    PeopleComponent.cpp

HEADERS +=     xpcfHelloPeopleAPI.h     xpcfHelloPeople_traits.h \
    PeopleComponent.h \
...
xpcf_xml_files.files=$$files($${PWD}/xpcfHelloPeople.xml)

INSTALLS += header_files target xpcf_xml_files
DISTFILES +=     Makefile \
    bcom-xpcfHelloPeople.pc.in \
    xpcfHelloPeople.xml
