...
call %XPCFROOT%/scripts/win/build_remaken_project.bat xpcf shared %QMAKEPATH% %XPCFROOT% %QTVERSION%
call %XPCFROOT%/scripts/win/build_remaken_project.bat xpcf static %QMAKEPATH% %XPCFROOT% %QTVERSION%
call %XPCFROOT%/scripts/win/build_remaken_project.bat xpcfSampleComponent shared %QMAKEPATH% %XPCFROOT%/samples/sample_component %QTVERSION%
