...
template<> XPCFSAMPLECOMPONENT_EXPORT_API component::HumanMusician* ComponentFactory::createInstance() {
    return new component::HumanMusician();
}
}}}
